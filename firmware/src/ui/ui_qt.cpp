...
extern "C" void ui_init(void)
{
	...
	g_window->setStyleSheet(
		"QWidget { background: #f4efe5; color: #1f2933; }"
	...
	g_progress_label = new QLabel(QStringLiteral("Waiting for a route from the broker"),
				      g_window);
